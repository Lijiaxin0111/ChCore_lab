...
void init_kernel_pt(void)
{
        ...
        for (; vaddr < PERIPHERAL_BASE + 0xffffff0000000000; vaddr += SIZE_2M) {
                boot_ttbr1_l2[GET_L2_INDEX(vaddr)] =
                        (vaddr - 0xffffff0000000000 ) /* high mem */
                        | UXN /* Unprivileged execute never */
                        | ACCESSED /* Set access flag */
                        | NG /* Mark as not global */
                        | INNER_SHARABLE /* Sharebility */
        ...
        /* BLANK BEGIN */
        for (vaddr = PERIPHERAL_BASE + 0xffffff0000000000; vaddr < PHYSMEM_END + 0xffffff0000000000; vaddr += SIZE_2M) {
                boot_ttbr1_l2[GET_L2_INDEX(vaddr)] =
                         (vaddr - 0xffffff0000000000) /* high mem */
                        | UXN /* Unprivileged execute never */
                        | ACCESSED /* Set access flag */
